...
**Calvert is wider than Montgomery**
Is the difference between Howard and everyone else significant? **Answer**
**Howard is pretty average in comparison to the othe counties**
...
**Baltimore city saw the largest increase in median income. None the counties seem to have had their median incomes fall.**
```{r}
md10 |>
...
**Which high school has the highest total median income? I'm not sure if adding the estimates up would give an accurate representation of the total median income because it is just an estimate.**
```{r}
...
**The schools with 60% or more graduates immediately enrolling in college have an average income of $42,196.06 more than those schools with less than 40% graduates immediately enrolling in college.**
```{r}
...
**Which school system has the highest average household income?**
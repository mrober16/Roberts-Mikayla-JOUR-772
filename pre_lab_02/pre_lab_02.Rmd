...
**Answer**
**to distinguish between which data set is being viewed/used**
...
```{r}
or_theatre_seats_15 <- umd_courses |> filter(department == "Theatre" | seats >= 15)

nrow(or_theatre_seats_15)
```
...
**Answer:**
**The dates are now formatted year-month-date**
...
**Answer**
**The date is now formatted year-date-month**
### Task 10: Mutate
...
**Answer**
**calculating the percentage of votes Moore recieved out of the total number of votes**
...
**Answer**
**The percent no longer needs to be formatted into a percentage and it's arranged by counties that had a higher percentage of votes for Moore**
...
**Answer**
**It can be useful depending on the angel of the story - the data itself is pretty objective.**
...
**Answer**
**str_to_lower converts to lower case** **str_to_title converts to title case, where the first letter of each word is capitalized** **str_to_sentence converts to sentence case, where only the first letter of a sentence is capitalized**
...
**Answer**
**The code is directing the program to detect the names of the states and to change them to abbreviations. If it doesn't identify the specified state names it should default to "NA".**
```{r}
...
**Answer**
**It does make it easier to identify the total expenses by state however, it leaves out other details that could be relevant depending on the story.**
...
1.**Which committee has the most media expenditures?**

2.**What is the the timeline of Amazon expenses?**  

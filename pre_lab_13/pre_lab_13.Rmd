...
**Answer**
**It shows us all 5 fields as columns: the state, educational spending per student in 2021, the GDP and population changes for 2021, and which candidate won the popular vote in the 2020 election**
```{r}
...
**Answer**
**There's a scatter plot that charts the population change as it relates to the GDP change with an average line and a shadow area that I think highlights the general range of the data**
```{r}
...
**Answer**
**There's a scatter plot that charts the GDP change as it relates to educational spending per student in 2021 with a line of best fit and the same shadow area highlighting the general range of the data**
```{r}
...
**Answer**
**Each field, except which candidate won the popular vote in the 2020 election, is being compared to one another**
```{r}
state_data |>
...
**Answer**
**It shows us a confidence interval, an alternative hypothesis, and the correlation of the data**
```{r}
...
**Task** Run the following code. Describe the model output. What do you see?
**Answer**
**It shows us a confidence interval, an alternative hypothesis, and the correlation of the educational funding data and GDP change**
```{r}
...
**Answer**
**It gives us the average of each field in terms of the 2020 candidate**
```{r}
state_data |>
  group_by(vote_2020) |>
  summarise(
...
**Answer**
**It shows us a confidence interval, an alternative hypothesis, and the average in each candidate's group**
```{r}

...
**https://datawrapper.dwcdn.net/o3Muf/1/**
...
**the map is zoomed in to the counties of Maryland instead of the whole U.S.**
...
**the bold text that appears when the courser hovers over a specific county now reads the county name and the parcentage of votes Moore received in that county**
...
**https://datawrapper.dwcdn.net/gVf6j/1/**
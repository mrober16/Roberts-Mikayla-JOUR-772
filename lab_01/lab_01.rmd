...
**A1**
**Engineering, Cooperative Education has the highest average number of seats. I was expecting it to be University Courses so this result shocked me.**
```{r}
umd_courses |>
 group_by(department) |>
 summarise(
...
**Considering the top 2 instructors that taught the most are recorded as "Instructor: TBA", that would make Keith Yearwood from Geographical Sciences the instructor that has taught the most.**
```{r}
umd_courses |>
...
**It would be a lot easier to tell who taught the most if I was also able to filter TBA results from the instructor category. I am not super confident in my response mostly because I'm unsure if I fully understood the variables I was asked to consider and if I filtered the information correctly.**
...
**1.Is there regulation on the average number of seats each department should offer in their courses? Since this question is more pointed to personnel logistics I have altered it to "What is the average number of seats each department offers in their courses?"**
```{r}
umd_courses |>
 group_by(department) |>
 summarise(

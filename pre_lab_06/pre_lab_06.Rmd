...
**They are arranged in different orders but they all have the same columns**
```{r}
...
**The increase in registered voters largely registered as Democrats over time. There was also a significant increase in the number of voters registered as "OTH" from 2020-2022.**
```{r}
...
**There are 24 rows but there should be 48 in total.**
```{r}
...
**the voters' zip code, race, and whether they're over the age of 18**
```{r}
...
**PG County has almost 61% of Black 18+ voters and 77% of the county votes Democrat.**
```{r}
...
**Howard County has about 19% of 18+ Asian voters in comparison to PG County who only has about %5.**
```{r}
maryland_population_with_voters_and_demographics |>

...
**Multiple versions of the same grantee**
```{r}
...
**Made the similar entries identical and changed the case of some entries**
```{r}
...
**Made all the entries capitalized, filtered out the results that begin with "W",combined all the duplicates**
```{r}
cleaned_md_grant_loans |>
...
**The differences aren't that significant it looks like it di the same thing with a different code**
```{r}
cleaned_md_grant_loans <- md_grant_loans |>
